...
<?php if (!$no_render) {?><?php if (!is_callable('smarty_modifier_capitalize')) include '/home/natha/Dropbox/School/AdvPHP/week15/libs/plugins/modifier.capitalize.php';
...
The current date and time is 2010-12-07 13:32:19

The value of global assigned variable $SCRIPT_NAME is /AdvPHP/week15/demo/index.php
...
testing strip tags
<table border=0><tr><td><A HREF="/AdvPHP/week15/demo/index.php"><font color="red">This is a  test     </font></A></td></tr></table>
